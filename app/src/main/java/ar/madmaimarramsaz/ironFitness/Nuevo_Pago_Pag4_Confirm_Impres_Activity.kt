...
class Nuevo_Pago_Pag4_Confirm_Impres_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_nuevo_pago_pag4_confirm_impres)
        ...
        //btn volver gris
        val btn_volver_gris: Button = findViewById(R.id.btn_volver_gris)
        btn_volver_gris.setOnClickListener {
            irAPagos()
        }
